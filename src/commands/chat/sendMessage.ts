...
export class SendMessage {
    @Slash({ name: "sendtextmessage", description: "Enviar texto simple", defaultMemberPermissions: PermissionFlagsBits.Administrator | PermissionFlagsBits.ManageMessages })
    async sendtext(
